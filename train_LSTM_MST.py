...
if __name__ == '__main__':
    ...
    train_iter, validation_iter, test_iter = DATASETS.iter(args, (MSTdatasets["train"], MSTdatasets["validation"], MSTdatasets["test"]), device)
    ...
    print("")
    print("### Misspelling Semantics Tokens ###")
    print("Training ...")
    model, output, train_stat = MODEL.train_model(args, train_iter, validation_iter, test_iter)

    print("")
    print("Testing ...")
    test_iter, corr_iter, misp_iter = DATASETS.iter(args, (MSTdatasets["test"], MSTdatasets["test-corr"], MSTdatasets["test-misp"]), device)
    ...
    test_iter, corr_iter, misp_iter = DATASETS.iter(args, (BOTHdataset["test"], BOTHdataset["test-corr"], BOTHdataset["test-misp"]), device)
